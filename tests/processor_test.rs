...
use llm_dataset_builder::processor::{OllamaClient, OllamaProcessor, ProcessedItem, DefaultOllamaProcessor};
...
async fn test_process_file_success() {
    ...
    mock_client
        ...
        .with(predicate::function(|content: &str| content.contains("Test Document")), predicate::eq(8))
        .times(1)
